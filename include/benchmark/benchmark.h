...
BENCHMARK_EXPORT bool ReportUnrecognizedArguments(int argc, const char** argv);
...
BENCHMARK_EXPORT Benchmark* RegisterBenchmarkInternal(const std::string& family,
